- **[メカ歩行RL 階段昇段 解決 (2026-08-15)](MECHA_RL_STAIRS_SOLVED_20260815.md)** — 階段10段完登 / survival 0.71-0.90。真因は報酬ではなく機体が自重を支えられないこと(238kg・KP質量比1.26)。修正した構造的欠陥7件と、報酬を触る前に測る4項目
