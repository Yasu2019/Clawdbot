...
PRESETS = {
    ...
    # 16GB VRAMの目安: 640x384 / 81frames / 20steps。不足時は 解像度 → フレーム数 → steps の順に下げる
    "wan22_t2v": {
        ...
        "POSITIVE_PROMPT": "A precision-stamped metal component rotates slowly on a dark inspection table. Macro lens, shallow depth of field, controlled studio lighting, smooth turntable motion.",
        "NEGATIVE_PROMPT": "low quality, blurry, overexposed, static, jpeg artifacts, text, watermark, distorted, deformed, extra limbs",
        "WIDTH": 640,
        "HEIGHT": 384,
        "LENGTH": 81,
        "SEED": 20260806,
        ...
        "SCHEDULER": "simple",
        "FPS": 24.0,
        "FILENAME_PREFIX": "video/mecha_studio_wan22",
    },
    # I2V。START_IMAGE は ComfyUI の input/ にあるファイル名（パスではない）
    "wan22_i2v": {
        "DIFFUSION_MODEL": "wan2.2_ti2v_5B_fp16.safetensors",
        "WEIGHT_DTYPE": "default",
        "SHIFT": 8.0,
        "TEXT_ENCODER": "umt5_xxl_fp8_e4m3fn_scaled.safetensors",
        "VAE_MODEL": "wan2.2_vae.safetensors",
        "START_IMAGE": "zaku_walk_start.png",
        "POSITIVE_PROMPT": "The mobile suit walks forward toward the camera with heavy deliberate footsteps, legs alternating, arms swinging slightly, hangar lights sweeping across the armor, dust drifting in the air",
        "NEGATIVE_PROMPT": "static, still image, no motion, frozen, low quality, blurry, jpeg artifacts, text, watermark, distorted, deformed, extra limbs, morphing",
        "WIDTH": 416,
        "HEIGHT": 704,
        "LENGTH": 81,
        "SEED": 20260811,
        ...
        "SCHEDULER": "simple",
        "FPS": 24.0,
        "FILENAME_PREFIX": "video/mecha_studio_wan22_i2v",
    },
    "scail2": {
