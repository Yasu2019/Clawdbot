...
importDXF.insert("/home/node/clawd/apps/dxf2step/test_output_S1/2.cleaned.dxf", "DXFImport")
...
if edges:
        ...
        if wires:
            ...
            if base_faces:
                ...
                if solids:
                    ...
                    result.exportStep("/home/node/clawd/apps/dxf2step/test_output_S1/2.step")
                    try:
                        out_doc = App.newDocument("LayerModel")
                        obj = out_doc.addObject("Part::Feature", "LayerSolid")
                        obj.Shape = result
                        out_doc.recompute()
                        out_doc.saveAs("/home/node/clawd/apps/dxf2step/test_output_S1/2.FCStd")
                        print(f"Saved FCStd: /home/node/clawd/apps/dxf2step/test_output_S1/2.FCStd")
                    except Exception as fce:
                        print(f"FCStd save failed: {fce}")
                    print(f"Exported: /home/node/clawd/apps/dxf2step/test_output_S1/2.step  faces={len(result.Faces)}")
                else:
    ...
    print("No edges found in /home/node/clawd/apps/dxf2step/test_output_S1/2.cleaned.dxf")
