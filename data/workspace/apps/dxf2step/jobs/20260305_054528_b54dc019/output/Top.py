...
importDXF.insert("/home/node/clawd/apps/dxf2step/jobs/20260305_054528_b54dc019/output/Top.cleaned.dxf", "DXFImport")
...
if edges:
    try:
        ...
        if faces:
            ...
            if solids:
                ...
                result.exportStep("/home/node/clawd/apps/dxf2step/jobs/20260305_054528_b54dc019/output/Top.step")
                print(f"Exported: /home/node/clawd/apps/dxf2step/jobs/20260305_054528_b54dc019/output/Top.step  faces={len(result.Faces)}")
            else:
    ...
    print("No edges found in /home/node/clawd/apps/dxf2step/jobs/20260305_054528_b54dc019/output/Top.cleaned.dxf")
