...
importDXF.insert("/home/node/clawd/apps/dxf2step/jobs/selfcheck3_20260228/View.cleaned.dxf", "DXFImport")
...
if edges:
    try:
        ...
        if faces:
            ...
            solid.exportStep("/home/node/clawd/apps/dxf2step/jobs/selfcheck3_20260228/View.step")
            print("Exported: /home/node/clawd/apps/dxf2step/jobs/selfcheck3_20260228/View.step")
        else:
            print("No closed faces found — check if DXF outlines form closed loops")
    except Exception as e:
        print(f"Error building solid: {e}")
else:
    print("No edges found in /home/node/clawd/apps/dxf2step/jobs/selfcheck3_20260228/View.cleaned.dxf")
