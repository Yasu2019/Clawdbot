...
importDXF.insert("/home/node/clawd/apps/dxf2step/jobs/20260228_152451_2ee770f4/output/ProjItem001.cleaned.dxf", "DXFImport")
...
if edges:
    try:
        ...
        if faces:
            ...
            for f in faces:
                try:
                    solids.append(f.extrude(App.Vector(0, 0, 10)))
            ...
            if solids:
                ...
                result.exportStep("/home/node/clawd/apps/dxf2step/jobs/20260228_152451_2ee770f4/output/ProjItem001.step")
                print(f"Exported: /home/node/clawd/apps/dxf2step/jobs/20260228_152451_2ee770f4/output/ProjItem001.step  faces={len(result.Faces)}")
            else:
    ...
    print("No edges found in /home/node/clawd/apps/dxf2step/jobs/20260228_152451_2ee770f4/output/ProjItem001.cleaned.dxf")
