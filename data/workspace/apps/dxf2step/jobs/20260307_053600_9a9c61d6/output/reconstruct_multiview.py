...
views_info = [
    ('front', '/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Front.cleaned.dxf'),
    ('top', '/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Top.cleaned.dxf'),
]
...
if len(slabs) >= 2:
    try:
        ...
        if vol > 0:
            ...
            result.exportStep('/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/combined.step')
            print('Reconstruction complete - volume:', result.Volume,
                  '- faces:', len(result.Faces))
        else:
            print('Intersection empty, falling back to compound')
            Part.makeCompound(slabs).exportStep('/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/combined.step')
    except Exception as e:
        print('Intersection failed, compound fallback:', e)
        Part.makeCompound(slabs).exportStep('/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/combined.step')
elif len(slabs) == 1:
    slabs[0].exportStep('/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/combined.step')
