...
importDXF.insert("/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Front.cleaned.dxf", "DXFImport")
...
if edges:
    try:
        ...
        if faces:
            ...
            for f in faces:
                try:
                    solids.append(f.extrude(App.Vector(0, 0, 100.0)))
            ...
            if solids:
                ...
                result.exportStep("/home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Front.step")
                print(f"Exported: /home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Front.step  faces={len(result.Faces)}")
            else:
    ...
    print("No edges found in /home/node/clawd/apps/dxf2step/jobs/20260307_053600_9a9c61d6/output/Front.cleaned.dxf")
