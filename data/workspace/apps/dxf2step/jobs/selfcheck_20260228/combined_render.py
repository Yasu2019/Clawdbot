...
shape = Part.read('/home/node/clawd/apps/dxf2step/jobs/selfcheck_20260228/combined.step')
bb = shape.BoundBox
...
plt.savefig('/home/node/clawd/apps/dxf2step/jobs/selfcheck_20260228/combined_views.png', dpi=150, bbox_inches='tight', facecolor='white')
plt.close()
print('PNG saved: /home/node/clawd/apps/dxf2step/jobs/selfcheck_20260228/combined_views.png')
