...
views_info = [
    ('front', '/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/View.cleaned.dxf'),
    ('top', '/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/ProjItem001.cleaned.dxf'),
    ('right', '/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/ProjItem.cleaned.dxf'),
]
...
if len(slabs) >= 2:
    try:
        ...
        if vol > 0:
            ...
            result.exportStep('/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/combined.step')
            print('Reconstruction complete - volume:', result.Volume,
                  '- faces:', len(result.Faces))
        else:
            print('Intersection empty, falling back to compound')
            Part.makeCompound(slabs).exportStep('/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/combined.step')
    except Exception as e:
        print('Intersection failed, compound fallback:', e)
        Part.makeCompound(slabs).exportStep('/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/combined.step')
elif len(slabs) == 1:
    slabs[0].exportStep('/home/node/clawd/apps/dxf2step/jobs/20260228_144308_ac141e8e/output/combined.step')
