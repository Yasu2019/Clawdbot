...
importDXF.insert("/home/node/clawd/apps/dxf2step/jobs/20260307_053521_236e07fa/output/0.cleaned.dxf", "DXFImport")
...
if edges:
    try:
        ...
        if faces:
            ...
            for f in faces:
                try:
                    solids.append(f.extrude(App.Vector(0, 0, 6.0)))
            ...
            if solids:
                ...
                result.exportStep("/home/node/clawd/apps/dxf2step/jobs/20260307_053521_236e07fa/output/0.step")
                print(f"Exported: /home/node/clawd/apps/dxf2step/jobs/20260307_053521_236e07fa/output/0.step  faces={len(result.Faces)}")
            else:
    ...
    print("No edges found in /home/node/clawd/apps/dxf2step/jobs/20260307_053521_236e07fa/output/0.cleaned.dxf")
