...
shape = Part.read('/home/node/clawd/apps/dxf2step/test_output_counterbore/0.step')
bb = shape.BoundBox
...
plt.savefig('/home/node/clawd/apps/dxf2step/test_output_counterbore/0_views.png', dpi=150, bbox_inches='tight', facecolor='white')
plt.close()
print('PNG saved: /home/node/clawd/apps/dxf2step/test_output_counterbore/0_views.png')
