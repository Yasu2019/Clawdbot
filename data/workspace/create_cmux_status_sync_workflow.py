...
WORKFLOW_NAME = "Sync Cmux Status JSON (Every 15m)"
ROOT = Path(__file__).resolve().parents[2]
BACKUP_DIR = ROOT / "backups" / "n8n"
STATUS_PATH = ROOT / "data" / "workspace" / "cmux_status_sync_workflow_status.json"
...
def build_workflow() -> dict:
    return {
        ...
        "nodes": [
            ...
            {
                "id": "node-sync",
                "name": "Update Cmux Status",
                "type": "n8n-nodes-base.executeCommand",
                "typeVersion": 1,
                "position": [260, 0],
                "parameters": {
                    "command": "python3 /workspace/update_cmux_status.py",
                },
            },
        ],
        "connections": {
            "Every 15 Minutes": {
                "main": [[{"node": "Update Cmux Status", "type": "main", "index": 0}]]
            }
        },
    }
...
def main() -> None:
    ...
    if existing:
        ...
        status["backup"] = backup_workflow(existing, "cmux_status_sync_update")
