...
Updated: 2026-06-03 22:37:38 JST

## Strengths
- Email watchdog is running: updated 0.5 minutes ago
- Continuous email ingest is active: stage=full_backfill age=0.5 minutes
- Auto repair patrol is recent: updated 4.3 minutes ago
- Idle maintenance is recent: updated 62.9 minutes ago
- Risk notification patrol is recent: updated 62.9 minutes ago
- Learning engine health endpoint is reachable: url=http://localhost:8110/health collections=16
- Paperless RAG watchdog is active: updated 0.8 minutes ago
...
- Paperless review artifacts are recent: age=0.8 minutes reason=ingest_progress
- Paperless ingest audit confirms recent documents are indexed: age=2.8 minutes
...
- Claudian watchdog is active: stage=warning age=0.9 minutes
- Mini PC optimizer watchdog is active: stage=healthy age=2.9 minutes
...
- Email SQLite integrity check is recent: age=336.9 minutes
