...
- Paperless ingest audit confirms recent documents are indexed: age=2.1 minutes
...
- Claudian watchdog is active: stage=healthy age=2.8 minutes
- Mini PC optimizer watchdog is active: stage=healthy age=8.7 minutes
...
- Email SQLite integrity check is recent: age=676.4 minutes
...
## Weaknesses
- [MEDIUM] Idle maintenance is stale: state=stale ageMinutes=22535.3
