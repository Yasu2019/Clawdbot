...
Updated: 2026-04-26 11:19:02 JST

## Strengths
- Email watchdog is running: updated 1.3 minutes ago
- Continuous email ingest is active: stage=full_backfill age=0.6 minutes
- Auto repair patrol is recent: updated 63.5 minutes ago
- Risk notification patrol is recent: updated 105.5 minutes ago
- Learning engine health endpoint is reachable: url=http://localhost:8110/health collections=13
- Paperless RAG watchdog is active: updated 1.5 minutes ago
- Gateway ingest watchdog process count is healthy: processes=1
- Paperless ingest heartbeat is fresh: stage=idle age=2.5 minutes
- Paperless review artifacts are recent: age=1.5 minutes reason=ingest_progress
- Paperless ingest audit confirms recent documents are indexed: age=1.1 minutes
...
- Claudian watchdog is active: stage=healthy age=3.4 minutes
...
- Email SQLite integrity check is recent: age=31.7 minutes
...
## Weaknesses
- [MEDIUM] Idle maintenance is stale: state=stale ageMinutes=22620.0
- [HIGH] Email blacklist hub API is offline or stale: processAlive=True state=healthy ageMinutes=64.0 configOk=False candidatesOk=False
