...
# Configuration
INPUT_DIR = r"D:\Clawdbot_Docker_20260125\clawstack_v2\data\paperless\consume\FEM_CAE"
OUTPUT_BASE_DIR = r"D:\Clawdbot_Docker_20260125\data\workspace\consume\fem_cae_wip"
        ...
        for i, page in enumerate(reader.pages):
            try:
                for img in page.images:
                    ...
                    # Simple filter to avoid tiny icons if needed, but for now take all
...
def main():
    ...
    print("FEM/CAE Ingestion Complete.")
