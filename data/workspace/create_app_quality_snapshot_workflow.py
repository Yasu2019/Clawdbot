...
WORKFLOW_NAME = "App Quality Snapshot (Daily 07:20 JST)"
ROOT = Path(__file__).resolve().parents[2]
BACKUP_DIR = ROOT / "backups" / "n8n"
STATUS_PATH = ROOT / "data" / "workspace" / "app_quality_snapshot_workflow_status.json"
...
def build_workflow() -> dict:
    return {
        ...
        "nodes": [
            {
                "id": "node-schedule",
                "name": "Daily 07:20 JST",
                "type": "n8n-nodes-base.scheduleTrigger",
                "typeVersion": 1.2,
                "position": [0, 0],
                "parameters": {
                    "rule": {
                        "interval": [{"field": "cronExpression", "expression": "20 7 * * *"}]
                    }
                },
            },
            {
                "id": "node-run",
                "name": "Run Quality Snapshot",
                "type": "n8n-nodes-base.executeCommand",
                "typeVersion": 1,
                "position": [280, 0],
                "parameters": {
                    "command": "python3 /workspace/run_app_quality_snapshot.py",
                    "executeOnce": True,
                },
            },
        ],
        "connections": {
            "Daily 07:20 JST": {
                "main": [[{"node": "Run Quality Snapshot", "type": "main", "index": 0}]]
            }
        },
    }
...
def main() -> None:
    ...
    if existing:
        ...
        status["backup"] = backup_workflow(existing, "app_quality_snapshot_update")
