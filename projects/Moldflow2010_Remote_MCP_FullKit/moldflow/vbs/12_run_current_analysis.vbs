...
Mark "BEFORE_ANALYZE sequence=" & study.AnalysisSequence
ok = study.AnalyzeNow2(True, True, False)
If Err.Number <> 0 Then Mark "ANALYZE_ERROR " & Err.Number & " " & Err.Description : WScript.Quit 3
Mark "AFTER_ANALYZE result=" & CStr(ok)
