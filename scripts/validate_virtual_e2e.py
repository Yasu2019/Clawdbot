...
def validate(root: Path) -> dict:
    ...
    required=['virtual_fields.vtu','virtual_thermo_pvt.vtu','virtual_thermo_pvt.manifest.json','quality/summary.json','quality/void_mechanisms.vtu','quality/void_mechanisms.manifest.json','calculix_from_pvt/solver_run.json','calculix_from_pvt/result_audit.json']
