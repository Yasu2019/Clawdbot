...
SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "domains": ["datasets", "visual_inspection", "manufacturing", "materials", "predictive_maintenance"],
        "priority": 1,
        "why": "Broad cross-repository search for datasets; use it to discover official landing pages before downloading anything.",
        "next_query": "manufacturing defect detection dataset injection molding dataset tolerance analysis dataset",
    },
    {
        ...
        "cost_label": "FREE_REG",
        "source_type": "dataset_model_platform",
        "domains": ["datasets", "deep_learning", "computer_vision", "nlp", "training"],
        "priority": 1,
        "why": "Useful for vision, OCR, document AI, and local model training. Requires per-dataset license review.",
        "next_query": "site:huggingface.co/datasets industrial defect anomaly detection manufacturing OCR quality",
    },
    {
        "name": "DataCite Commons",
        "url": "https://commons.datacite.org/",
        "cost_label": "FREE",
        "source_type": "research_data_index",
        "domains": ["datasets", "papers", "manufacturing", "materials"],
        "priority": 2,
        "why": "DOI-backed dataset discovery across repositories, useful when papers mention a DOI but not a direct file page.",
        "next_query": "DataCite manufacturing defect dataset sheet metal forming injection molding",
    },
    {
        "name": "DOE Data Explorer",
        "url": "https://www.osti.gov/dataexplorer/",
        "cost_label": "FREE",
        "source_type": "official_repository",
        "domains": ["datasets", "materials", "simulation", "energy", "manufacturing"],
        "priority": 3,
        "why": "US DOE dataset search for materials, simulation, and engineering datasets.",
        "next_query": "site:osti.gov/dataexplorer manufacturing simulation materials dataset",
    },
    {
        "name": "NIMS Materials Data Repository",
        "url": "https://mdr.nims.go.jp/",
        "cost_label": "FREE",
        "source_type": "materials_repository",
        "domains": ["materials", "datasets", "japanese", "simulation"],
        "priority": 2,
        "why": "Materials data from NIMS; useful for resin, metal, and material-property grounding.",
        "next_query": "site:mdr.nims.go.jp material property dataset polymer steel forming",
    },
    {
        ...
        "domains": ["materials", "datasets", "simulation"],
        "priority": 3,
        "why": "High-quality materials database; account/API terms may apply. More useful for material-learning foundations than immediate mold/press work.",
        "next_query": "Materials Project API license materials property dataset",
    },
    {
        "name": "Google Patents",
        ...
        "domains": ["patents", "progressive_die", "injection_molding", "fixture", "mechanism"],
        "priority": 1,
        "why": "Fast patent search for progressive dies, injection molds, gates, cooling channels, press tooling, and inspection fixtures.",
        "next_query": "progressive die strip layout injection mold cooling channel gate design patent",
    },
    {
        "name": "J-PlatPat",
        ...
        "cost_label": "FREE",
        "source_type": "patent_search",
        "domains": ["patents", "japanese", "progressive_die", "injection_molding", "quality"],
        "priority": 1,
        "why": "Official Japanese patent search; important for domestic tooling and manufacturing ideas.",
        "next_query": "J-PlatPat 順送金型 射出成形 金型 品質検査 特許",
    },
    {
        "name": "Espacenet",
        ...
        "cost_label": "FREE",
        "source_type": "patent_search",
        "domains": ["patents", "automotive", "mold_design", "forming"],
        "priority": 2,
        "why": "International patent search to compare global mold, forming, and inspection mechanisms.",
        "next_query": "Espacenet progressive die injection mold warpage inspection fixture patent",
    },
    {
        "name": "GrabCAD Library",
        "url": "https://grabcad.com/library",
        "cost_label": "FREE_REG",
        "source_type": "cad_model_platform",
        "domains": ["cad", "3d_model", "mechanism", "fixture", "training"],
        "priority": 3,
        "why": "Useful for reference CAD and training models. Every model needs license and attribution review.",
        "next_query": "GrabCAD progressive die injection mold fixture press tool CAD model",
    },
    {
        "name": "TraceParts",
        "url": "https://www.traceparts.com/",
        "cost_label": "FREE_REG",
        "source_type": "cad_parts_catalog",
        "domains": ["cad", "standard_parts", "mechanical_design"],
        "priority": 3,
        "why": "Standard-part CAD catalog for building realistic tooling examples; registration may be required.",
        "next_query": "TraceParts mold components guide pins die springs CAD",
    },
    {
        ...
        "domains": ["cad", "standard_parts", "mechanical_design"],
        "priority": 3,
        "why": "Mechanical CAD parts and supplier models for fixtures and training examples. Check download terms.",
        "next_query": "3D ContentCentral mold base die spring press fixture CAD",
    },
    {
        "name": "Blender Manual",
        ...
        "cost_label": "FREE",
        "source_type": "official_docs",
        "domains": ["3d_generation", "rendering", "training_video", "visualization"],
        "priority": 2,
        "why": "Official reference for 3D video generation, rendering, and CAE result visualization pipelines.",
        "next_query": "Blender manual camera animation materials lighting python rendering",
    },
    {
        ...
        "cost_label": "FREE",
        "source_type": "official_docs",
        "domains": ["training_video", "automation", "3d_generation", "content_generation"],
        "priority": 2,
        "why": "Useful for scripted educational videos, audit training videos, and dashboard-to-video workflows.",
        "next_query": "Remotion data driven video captions charts animation documentation",
    },
    {
        "name": "FreeCAD Documentation",
        "url": "https://wiki.freecad.org/",
        "cost_label": "FREE",
        "source_type": "official_docs",
        "domains": ["cad", "dxf", "step", "automation", "mechanical_design"],
        "priority": 2,
        "why": "Reference for DXF/STEP automation and geometry prep before CAE or mold design.",
        "next_query": "FreeCAD python API DXF STEP automation part design",
    },
    {
        "name": "GitHub Topics",
        ...
        "domains": ["implementation", "open_source", "deep_learning", "cae", "automation"],
        "priority": 2,
        "why": "Find code candidates for anomaly detection, OpenFOAM utilities, CAD automation, and reporting tools. License review required before reuse.",
        "next_query": "github topics industrial anomaly detection openfoam injection molding freecad dxf step",
    },
    {
        ...
        "domains": ["training", "statistics", "mechanical_design", "manufacturing", "simulation"],
        "priority": 3,
        "why": "Free education material for engineering math, statistics, manufacturing, and mechanics foundations.",
        "next_query": "MIT OCW manufacturing design statistics finite element method quality",
    },
    {
        "name": "PubMed Central",
...
DOMAIN_LABELS = {
    ...
    "patents_cad_assets": ["patents", "cad", "3d_model", "standard_parts", "mechanical_design"],
    "materials_data": ["materials", "simulation", "datasets"],
}
