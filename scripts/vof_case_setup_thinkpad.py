#!/usr/bin/env python3
"""VOF R2 fine mesh case for ThinkPad - 80x40x8 cells (25600 total)."""
import pathlib

BASE = pathlib.Path.home() / "clawstack_jobs" / "vof_cavity_R2"
...
blocks ( hex (0 1 2 3 4 5 6 7) (80 40 8) simpleGrading (1 1 1) );
edges ();
boundary (
...
adjustTimeStep yes; maxCo 0.5; maxAlphaCo 0.5; maxDeltaT 5e-4;
"""
...
solvers {
  "alpha.water.*" { nAlphaCorr 2; nAlphaSubCycles 1; cAlpha 1; MULESCorr yes; nLimiterIter 3; solver smoothSolver; smoother symGaussSeidel; tolerance 1e-8; relTol 0; minIter 1; }
